...
public abstract class CourseServiceConnectedActivity extends AppCompatActivity {

    protected CourseManagementService myService;
    ...
    protected ServiceConnection myConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className,
            ...
            myService = ((CourseManagementService.LocalBinder) service).getService();
            isBound = true;
